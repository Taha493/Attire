  ...
  useEffect(() => {
    const fetchTopSelling = async () => {
      try {
        ...
        const topSellingData = await productService.getTopSelling({ limit });
        // Ensure the response is an array
        const productsArray = Array.isArray(topSellingData)
          ? topSellingData
          : [];
  ...
  if (loading) {
    return (
      <section className="py-6 sm:py-8 md:py-10">
        <h2 className="font-plak text-2xl sm:text-3xl font-bold text-center mb-6 sm:mbCssStyleDeclaration-8">
          TOP SELLING
        </h2>
  ...
  if (isDashboard) {
    return (
      <section className="py-6 sm:py-8 md:py-10">
        ...
        {location.pathname !== "/products/top-selling" && (
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
              <h1 className="text-2xl font-bold mb-2 sm:mb-0">Top Selling</h1>
