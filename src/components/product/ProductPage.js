    ...
    const fetchProduct = async () => {
      ...
      try {
        ...
        const mockProductData = {
          ...
          imageSrc: "/api/placeholder/500/500",
          images: [
            "/api/placeholder/500/500",
            "/api/placeholder/500/500",
            "/api/placeholder/500/500",
          ...
          description:
            "A stylish graphic T-shirt made from high-quality cotton, perfect for casual wear.",
        ...
        if (mockProductData.colors && mockProductData.colors.length > 0) {
          setSelectedColor(mockProductData.colors[0]);
        }

        if (mockProductData.sizes && mockProductData.sizes.length > 0) {
          setSelectedSize(mockProductData.sizes[0]);
        }

        // Simulate checking wishlist status (client-side)
        setIsWishlisted(false); // Default to not wishlisted
      } catch (error) {
